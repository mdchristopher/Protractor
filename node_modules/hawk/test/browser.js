...
describe('Browser', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('http://specs.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-data' });
            req.url += '&bewit=' + bewit;
    ...
    it('should generate a bewit then successfully authenticate it (no ext)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Browser.client.bewit('http://specs.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100 });
            req.url += '&bewit=' + bewit;
    ...
    describe('bewit()', function () {
        ...
        it('returns a valid bewit value', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
        ...
        it('returns a valid bewit value (explicit HTTP port)', function (done) {
            ...
            var bewit = Browser.client.bewit('http://specs.com:8080/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
        ...
        it('returns a valid bewit value (explicit HTTPS port)', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com:8043/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
        ...
        it('returns a valid bewit value (null ext)', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: null });
        ...
        it('errors on invalid options', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', 4);
        ...
        it('errors on invalid credentials (id)', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 3000, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing credentials', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', { ttlSec: 3000, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on invalid algorithm', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing options', function (done) {
            ...
            var bewit = Browser.client.bewit('https://specs.com/somewhere/over/the/rainbow');
            expect(bewit).to.equal('');
            done();
        });
    });
    ...
    it('generates a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' }).field;
    ...
    it('generates a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var reqHeader = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', payload: payload, contentType: req.headers['content-type'] });
    ...
    it('generates a header then successfully parse it (time offset)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', localtimeOffsetMsec: 100000 }).field;
            expect(req.authorization).to.exist();
    ...
    it('generates a header with stale ts and successfully authenticate on second call', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var header = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data' });
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts2) {
                ...
                req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials2, ext: 'some-app-data' }).field;
                expect(req.authorization).to.exist();
    ...
    it('generates a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, payload: 'hola!', ext: 'some-app-data' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    it('generates a header then successfully parse it (app, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            req.authorization = Browser.client.header('http://specs.com:8080/resource/4?filter=a', req.method, { credentials: credentials1, ext: 'some-app-data', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials2, artifacts) {
    ...
    describe('client', function () {
        ...
        describe('header()', function () {
            ...
            it('returns a valid authorization header (sha1)', function (done) {
                ...
                var header = Browser.client.header('http://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about' }).field;
            ...
            it('returns a valid authorization header (sha256)', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }).field;
            ...
            it('returns a valid authorization header (empty payload)', function (done) {
                ...
                var header = Browser.client.header('http://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: '' }).field;
            ...
            it('returns a valid authorization header (no ext)', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }).field;
            ...
            it('returns a valid authorization header (null ext)', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain', ext: null }).field;
                expect(header).to.equal('Hawk id="123456", ts="1353809207", nonce="Ygvqdz", hash="2QfCt3GuY9HQnHWyWD3wX68ZOKbynqlfYmuO2ZBRqtY=", mac="HTgtd0jPI6E4izx8e4OHdO36q00xFCU0FolNq3RiCYs="');
                done();
            });
            ...
            it('returns a valid authorization header (uri object)', function (done) {
                ...
                var uri = Browser.utils.parseUri('https://specs.net/somewhere/over/the/rainbow');
            ...
            it('errors on missing options', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST');
            ...
            it('errors on missing method', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', '', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' });
                expect(header.field).to.equal('');
                expect(header.err).to.equal('Invalid argument type');
                done();
            });
            ...
            it('errors on invalid method', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 5, { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' });
                expect(header.field).to.equal('');
                expect(header.err).to.equal('Invalid argument type');
                done();
            });
            ...
            it('errors on missing credentials', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { ext: 'Bazinga!', timestamp: 1353809207 });
                expect(header.field).to.equal('');
            ...
            it('errors on invalid credentials (id)', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207 });
                expect(header.field).to.equal('');
                expect(header.err).to.equal('Invalid credentials object');
                done();
            });
            ...
            it('errors on invalid algorithm', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, payload: 'something, anything!', ext: 'Bazinga!', timestamp: 1353809207 });
                expect(header.field).to.equal('');
            ...
            it('uses a pre-calculated payload hash', function (done) {
                ...
                var header = Browser.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', options).field;
                expect(header).to.equal('Hawk id="123456", ts="1353809207", nonce="Ygvqdz", hash="2QfCt3GuY9HQnHWyWD3wX68ZOKbynqlfYmuO2ZBRqtY=", ext="Bazinga!", mac="q1CwFoSHzPZSkbIvl0oYlD+91rBUEvFk763nMjMndj8="');
                done();
            });
        });
        ...
        describe('message()', function () {
            ...
            it('generates an authorization then successfully parse it', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials1) {
                    ...
                    var auth = Browser.client.message('specs.com', 8080, 'some message', { credentials: credentials1 });
                    expect(auth).to.exist();

                    Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, credentialsFunc, {}, function (err, credentials2) {
            ...
            it('generates an authorization using custom nonce/timestamp', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 8080, 'some message', { credentials: credentials, nonce: 'abc123', timestamp: 1398536270957 });
                    expect(auth).to.exist();
            ...
            it('errors on missing port', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 0, 'some message', { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on invalid port', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 'a', 'some message', { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on missing message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 8080, undefined, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on null message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 8080, null, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on invalid message', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    var auth = Browser.client.message('specs.com', 8080, 5, { credentials: credentials });
                    expect(auth).to.not.exist();
                    done();
                });
            });
            ...
            it('errors on missing credentials', function (done) {
                ...
                var auth = Browser.client.message('specs.com', 8080, 'some message', {});
                expect(auth).to.not.exist();
                done();
            });
            ...
            it('errors on invalid credentials (id)', function (done) {
                ...
                credentialsFunc('123456', function (err, credentials) {
                    ...
                    delete creds.id;
                    var auth = Browser.client.message('specs.com', 8080, 'some message', { credentials: creds });
                    expect(auth).to.not.exist();
                    done();
                });
            });
    ...
    describe('utils', function () {
        ...
        describe('parseUri()', function () {
            ...
            it('returns empty port when unknown scheme', function (done) {
                ...
                var uri = Browser.utils.parseUri('ftp://specs.com');
            ...
            it('returns default port when missing', function (done) {
                ...
                var uri = Browser.utils.parseUri('http://specs.com');
