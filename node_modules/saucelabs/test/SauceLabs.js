    ...
    describe('#createPublicLink', function () {
      ...
      describe('with job ID, date and hour', function () {
        it('creates the proper link', function (done) {
          var expected = 'https://saucelabs.com/jobs/01230123-specs-id-1234?auth=8bcfe0b2e888794a63050ea74ad12005';
      ...
      describe('with job ID and date', function () {
        it('creates the proper link', function (done) {
          var expected = 'https://saucelabs.com/jobs/01230123-specs-id-1234?auth=c86f247871504dfc1b11736b334b2409';
      ...
      describe('with job ID', function () {
        it('creates the proper link', function (done) {
          var expected = 'https://saucelabs.com/jobs/01230123-specs-id-1234?auth=211e7791e357ddbc22065b864167d3c9';
