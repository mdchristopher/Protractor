 ...
 * For specs, (goog.functions.compose(f, g))(a) is equivalent to f(g(a)).
 ...
 * returns the value of the last function. For specs,
 ...
 * For specs, (goog.functions.and(f, g))(x) is equivalent to f(x) && g(x).
 * @param {...Function} var_args A list of functions.
 ...
 * For specs, (goog.functions.or(f, g))(x) is equivalent to f(x) || g(x).
 * @param {...Function} var_args A list of functions.
 ...
 * For specs, (goog.functions.not(f))(x) is equivalent to !f(x).
 * @param {!Function} f The original function.
