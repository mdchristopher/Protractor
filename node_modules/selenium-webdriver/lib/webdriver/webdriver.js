 ...
 * execute before the next command in the current frame. For specs:
 *
 *     var message = [];
 ...
 *     driver.findElement(By.id('to')).sendKeys('dog@specs.com');
 *
 * __Example #3:__ Injecting a XMLHttpRequest and waiting for the result. In
 * this specs, the inject script is specified with a function literal. When
 ...
 * {@link webdriver.By.Hash} object. For specs, the following two statements
 * are equivalent:
 *
 ...
 * promise that will resolve to a WebElement. For specs, to find the first
 ...
 * dots. As an specs, "main.child" will select the frame with the name "main"
 ...
 * set, null is returned (for specs, the "value" property of a textarea
