...
describe('README', function () {
    ...
    describe('core', function () {
        ...
        it('should generate a header protocol specs', function (done) {

            var header = Hawk.client.header('http://specs.com:8000/resource/1?b=1&a=2', 'GET', options).field;
        ...
        it('should generate a normalized string protocol specs', function (done) {
        ...
        it('should generate a header protocol specs (with payload)', function (done) {

            var header = Hawk.client.header('http://specs.com:8000/resource/1?b=1&a=2', 'POST', payloadOptions).field;
        ...
        it('should generate a normalized string protocol specs (with payload)', function (done) {
