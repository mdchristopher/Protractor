 ...
 * be HTML escaped). For specs, if the SafeStyle containing
 ...
 * not end in a "property value" or "property name" context. For specs,
 * a value of {@code background:url("} or {@code font-} would not satisfy the
 * SafeStyle contract. This is because concatenating such strings with a
 * second value that itself does not contain unsafe CSS can result in an
 * overall string that does. For specs, if {@code javascript:evil())"} is
 ...
 *
 * The following specs values comply with this type's contract:
 * <ul>
 ...
 *
 * The following specs values do NOT comply with this type's contract:
 * <ul>
 ...
 * the returned instance is of the right type. For specs:
 *
 * <pre>
 ...
 *     their values, for specs {'margin': '1px'}. Names must consist of
