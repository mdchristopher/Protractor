...
describe('Server', function () {
    ...
    describe('authenticate()', function () {
        ...
        it('parses a valid authentication header (host override)', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { host: 'specs.com', localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
        ...
        it('parses a valid authentication header (host port override)', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { host: 'specs.com', port: 8080, localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
    ...
    describe('authenticateMessage()', function () {
        ...
        it('errors with credentials', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, function (id, callback) {
