...
describe('Client', function () {
    ...
    describe('header()', function () {
        ...
        it('returns a valid authorization header (sha1)', function (done) {
            ...
            var header = Hawk.client.header('http://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about' }).field;
        ...
        it('returns a valid authorization header (sha256)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }).field;
        ...
        it('returns a valid authorization header (no ext)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain' }).field;
        ...
        it('returns a valid authorization header (null ext)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about', contentType: 'text/plain', ext: null }).field;
            expect(header).to.equal('Hawk id="123456", ts="1353809207", nonce="Ygvqdz", hash="2QfCt3GuY9HQnHWyWD3wX68ZOKbynqlfYmuO2ZBRqtY=", mac="HTgtd0jPI6E4izx8e4OHdO36q00xFCU0FolNq3RiCYs="');
            done();
        });
        ...
        it('returns a valid authorization header (empty payload)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: '', contentType: 'text/plain' }).field;
        ...
        it('returns a valid authorization header (pre hashed payload)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', options).field;
            expect(header).to.equal('Hawk id="123456", ts="1353809207", nonce="Ygvqdz", hash="2QfCt3GuY9HQnHWyWD3wX68ZOKbynqlfYmuO2ZBRqtY=", mac="HTgtd0jPI6E4izx8e4OHdO36q00xFCU0FolNq3RiCYs="');
            done();
        });
        ...
        it('errors on missing method', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', '');
            expect(header.field).to.equal('');
            expect(header.err).to.equal('Invalid argument type');
            done();
        });
        ...
        it('errors on invalid method', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 5);
            expect(header.field).to.equal('');
            expect(header.err).to.equal('Invalid argument type');
            done();
        });
        ...
        it('errors on missing options', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST');
            expect(header.field).to.equal('');
            expect(header.err).to.equal('Invalid argument type');
            done();
        });
        ...
        it('errors on invalid credentials (id)', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207 });
            expect(header.field).to.equal('');
        ...
        it('errors on missing credentials', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { ext: 'Bazinga!', timestamp: 1353809207 });
            expect(header.field).to.equal('');
            expect(header.err).to.equal('Invalid credential object');
            done();
        });
        ...
        it('errors on invalid algorithm', function (done) {
            ...
            var header = Hawk.client.header('https://specs.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, payload: 'something, anything!', ext: 'Bazinga!', timestamp: 1353809207 });
            expect(header.field).to.equal('');
    ...
    describe('message()', function () {
        ...
        it('generates authorization', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 80, 'I am the boodyman', { credentials: credentials, timestamp: 1353809207, nonce: 'abc123' });
        ...
        it('errors on missing host', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 0, 'I am the boodyman', { credentials: credentials, timestamp: 1353809207, nonce: 'abc123' });
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('errors on null message', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 80, null, { credentials: credentials, timestamp: 1353809207, nonce: 'abc123' });
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('errors on missing message', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 80, undefined, { credentials: credentials, timestamp: 1353809207, nonce: 'abc123' });
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('errors on invalid message', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 80, 5, { credentials: credentials, timestamp: 1353809207, nonce: 'abc123' });
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('errors on missing options', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 80, 'I am the boodyman');
            expect(auth).to.not.exist();
            done();
        });
