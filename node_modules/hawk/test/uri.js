...
describe('Uri', function () {
    ...
    it('should generate a bewit then successfully authenticate it', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Hawk.uri.getBewit('http://specs.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-app-data' });
            req.url += '&bewit=' + bewit;
    ...
    it('should generate a bewit then successfully authenticate it (no ext)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials1) {
            ...
            var bewit = Hawk.uri.getBewit('http://specs.com/resource/4?a=1&b=2', { credentials: credentials1, ttlSec: 60 * 60 * 24 * 365 * 100 });
            req.url += '&bewit=' + bewit;
    ...
    describe('getBewit()', function () {
        ...
        it('returns a valid bewit value', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
        ...
        it('returns a valid bewit value (explicit port)', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com:8080/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
        ...
        it('returns a valid bewit value (null ext)', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: null });
        ...
        it('returns a valid bewit value (parsed uri)', function (done) {
            ...
            var bewit = Hawk.uri.getBewit(Url.parse('https://specs.com/somewhere/over/the/rainbow'), { credentials: credentials, ttlSec: 300, localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(), ext: 'xandyandz' });
            expect(bewit).to.equal('MTIzNDU2XDEzNTY0MjA3MDdca3NjeHdOUjJ0SnBQMVQxekRMTlBiQjVVaUtJVTl0T1NKWFRVZEc3WDloOD1ceGFuZHlhbmR6');
            done();
        });
        ...
        it('errors on invalid options', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', 4);
        ...
        it('errors on invalid credentials (id)', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 3000, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing credentials', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', { ttlSec: 3000, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on invalid algorithm', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 300, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing options', function (done) {
            ...
            var bewit = Hawk.uri.getBewit('https://specs.com/somewhere/over/the/rainbow');
            expect(bewit).to.equal('');
            done();
        });
    });
    ...
    describe('authenticateMessage()', function () {
        ...
        it('should generate an authorization then successfully parse it', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('specs.com', 8080, 'some message', { credentials: credentials1 });
        ...
        it('should fail authorization on stale timestamp', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, credentialsFunc, { localtimeOffsetMsec: 100000 }, function (err, credentials2) {
        ...
        it('overrides timestampSkewSec', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('specs.com', 8080, 'some message', { credentials: credentials1, localtimeOffsetMsec: 100000 });
                expect(auth).to.exist();

                Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, credentialsFunc, { timestampSkewSec: 500 }, function (err, credentials2) {
        ...
        it('should fail authorization on bad hash', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('specs.com', 8080, 'some message1', auth, credentialsFunc, {}, function (err, credentials2) {
        ...
        it('should fail authorization on nonce error', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, credentialsFunc, {
        ...
        it('should fail authorization on credentials error', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                Hawk.server.authenticateMessage('specs.com', 8080, 'some message', auth, errFunc, {}, function (err, credentials2) {
        ...
        it('should fail on missing credentials', function (done) {
            ...
            var auth = Hawk.client.message('specs.com', 8080, 'some message', {});
            expect(auth).to.not.exist();
            done();
        });
        ...
        it('should fail on invalid algorithm', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials1) {
                ...
                var auth = Hawk.client.message('specs.com', 8080, 'some message', { credentials: creds });
                expect(auth).to.not.exist();
                done();
            });
        });
