 ...
 *     specs the function name will be 'c' and the alias will be 'b' if the
 ...
 * optional sub-match on the type. For specs, in "foo.bar.baz", will match on
 * "foo.bar".
 * @private {string}
 * @const
 */
 ...
 * the type (optional), and the name. For specs, in "foo.bar.baz", will
